export default [
    {Git:'https://github.com/DivineGordon/redux-online-store',
      name: "Online Store App",des:"A <b>React-Redux</b> Online Store",
link:"https://divinegordon.github.io/redux-online-store/",
img:{alt:"React-Redux Online Store",src:"shopping-cart-demo.gif"},

front:["React","Redux"],
long_des:["Display inventory on home page",
"Search database for specific products",
"Change currency of products",
...
front:["React"],
long_des:["A portfolio website using React",
...
},
{
  ...
  long_des:[
    "Home page",
    "Search for a pet by type,name or location",
  "View search results",
...
{  name:"Spotify Jammming App",img:{src:"jammming.JPG",
 alt:"Spotify playlist creator"},
  ...
  long_des:["Search for a song, album or artist on the Spotify database.",
   "View search results",
  "Create a playlist",
